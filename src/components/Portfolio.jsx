...
const projects = [
  {
    thumbnail: "/images/chatWrapped-thumbnail.png",
    title: "chatwrapped",
    link: "https://www.chatwrapped.app/",
    desc: "AI-powered chat analyzer creating custom personas, roasts, and analytics from conversation history.",
    lang: ["TypeScript ", "Next.js", "React ", "Vercel"],
  },
  {
